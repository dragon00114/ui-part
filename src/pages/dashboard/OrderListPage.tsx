...
const TABLE_HEAD = [
  { id: 'orderId', label: 'Order', align: 'left' },
  { id: 'customerName', label: 'Customer', align: 'left' },
  { id: 'dueDate', label: 'Date', align: 'left' },
  { id: 'price', label: 'Price', align: 'center', width: 140 },
  { id: 'items', label: 'Items', align: 'center', width: 140 },
...
export default function OrderListPage() {
  ...
  const handleViewRow = (id: string) => {
    navigate(PATH_DASHBOARD.invoice.order_view(id));
  };
